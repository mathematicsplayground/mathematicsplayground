<?php 
$title = 'Hafaliadau Cwadratig - Maes Chwarae Mathemateg';
			...
			<div class="span9">
				...
				<div class="dropdown clearfix" style='float: right; margin-left: 1em; margin-bottom: 2em;'>
					<ul class="dropdown-menu" style="display: block; position: static; margin-bottom: 5px; *width: 180px;">
						<li><a href="#cwadratig">Hafaliadau Cwadratig</a></li>
					</ul>
				</div>

				<div>
					<h2 id='cwadratig'>Hafaliadau Cwadratig</h2>
					...
					<p>Mae'r graff isod yn dangos hafaliad cwadratig. Rheolwch baramedrau $a$, $b$ a $c$ trwy symud y llithryddion ar waelod y graff. Cyfrifir y pwyntiau y mae’r cromlin yn croesi'r echelon X o dan y graff.</p>

					<br /><br />

					<center><div id='qegraph' class='jxgbox medgraph'></div></center>
					<div class='graphcontrols'><button onclick="JXG.JSXGraph.freeBoard(qejsx); initQe();">Ailosod safleoedd</button> <span class='mousepos' id='qemousepos'></span></div>
						...
						function initQe() {
							...
							qejsx.on('update', function() {
								...
								if ((Math.pow(b, 2) - 4 * a * c) > 0) {
								  ...
								  $("#qeformula3").text("$x = \\frac{" + -b + " \\pm \\sqrt{" + b + "^2 - 4*" + a + "*" + c + "}}{-2 * " + a + "} = " + solution1 + "$ neu $" + solution2 + "$");
