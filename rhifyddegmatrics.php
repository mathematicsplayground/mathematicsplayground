<?php 
$title = 'Rhifyddeg Matrics - Maes Chwarae Mathemateg';
			...
			<div class="span9">
				...
				<div class="dropdown clearfix" style='float: right; margin-left: 1em; margin-bottom: 2em;'>
					<ul class="dropdown-menu" style="display: block; position: static; margin-bottom: 5px; *width: 180px;">
						...
						<li><a href="#sgalar">Lluosi Matrics - Sgalar</a></li>
						<li><a href="#lluosi">Lluosi</a></li>
					</ul>
				</div>
				...
				<div>
					...
					<p>Mae'r ddau fatrics isod yn cael eu adio gyda'i gilydd, newidiwch y gwerthoedd yn y naill fatrics neu'r llall a gwyliwch sut mae'r canlyniad yn newid.</p>
				...
				<div style='clear: left; padding-top: 2em;'>
					...
					<p>Yn yr enghraifft isod, tynnir yr ail fatrics o'r matrics cyntaf, newidiwch y gwerthoedd yn y naill fatrics neu'r llall a gwyliwch sut mae'r canlyniad yn newid.</p>
				...
				<div style='clear: left; padding-top: 2em;'>
					<h2 id='sgalar'>Lluosi Matrics - Sgalar</h2>

					<br />

					<p>Yn yr enghraifft isod, lluosir matrics gan werth sgalar, newidiwch un ai'r gwerth sgalar neu'r gwerthoedd yn y matrics a gwyliwch sut mae'r canlyniad yn newid.</p>
				...
				<div style='clear: left; padding-top: 2em;'>
					<h2 id='lluosi'>Lluosi</h2>

					<br />

					<p>Mae'r ddau fatrics isod yn cael eu lluosi gyda'i gilydd, newidiwch y gwerthoedd yn y naill fatrics neu’r llall a gwyliwch sut mae’r canlyniad yn newid.</p>
