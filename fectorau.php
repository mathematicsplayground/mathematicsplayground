<?php 
$title = 'Fectorau - Maes Chwarae Mathemateg';
			...
			<div class="span9">
				...
				<div class="dropdown clearfix" style='float: right; margin-left: 1em; margin-bottom: 2em;'>
					<ul class="dropdown-menu" style="display: block; position: static; margin-bottom: 5px; *width: 180px;">
						<li><a href="#sgalarau">Sgalarau</a></li>
						<li><a href="#adio">Adio</a></li>
						<li><a href="#tynnu">Tynnu</a></li>
						<li><a href="#cynnyrchdot">Cynnyrch Dot</a></li>
						<li><a href="#hafaliadllinell">Hafaliad Llinell</a></li>
					</ul>
				</div>

				<div>
					<h2 id='sgalarau'>Sgalarau</h2>

					<br />

					<p>Mae'r graff isod yn dangos tri fector sy'n rhannu'r un cydran sgalar. Cymhwyswch y llithrydd ar frig y graff i newid y gwerth sgalar. Dangosir diffiniad pob fector o dan y graff.</p>

					<br /><br />

					<center><div id='slrgraph' class='jxgbox medgraph'></div></center>
					<div class='graphcontrols'><button onclick="JXG.JSXGraph.freeBoard(slrjsx); initSlr();">Ailosod safleoedd</button> <span class='mousepos' id='slrmousepos'></span></div>
				...
				<div>
					...
					<p>Llusgwch bennau'r ddau fector du i newid eu cyfeiriad a'u maint. Mae'r fector glas yn dangos canlyniad adio'r ddau fector du at ei gilydd.</p>

					<br /><br />

					<center><div id='addgraph' class='jxgbox medgraph'></div></center>
					<div class='graphcontrols'><button onclick="JXG.JSXGraph.freeBoard(addjsx); initAdd();">Ailosod safleoedd</button> <span class='mousepos' id='addmousepos'></span></div>
				...
				<div style='clear: both;'>
					...
					<h2 id='tynnu'>Tynnu</h2>

					<br />

					<p>Llusgwch bennau'r ddau fector du i newid eu cyfeiriad a'u maint. Mae'r fector gwyrdd yn dangos canlyniad tynnu f1 o f2.</p>

					<br /><br />

					<center><div id='subgraph' class='jxgbox medgraph'></div></center>
					<div class='graphcontrols'><button onclick="JXG.JSXGraph.freeBoard(subjsx); initSub();">Ailosod safleoedd</button> <span class='mousepos' id='submousepos'></span></div>
					...
					<script type='text/javascript'>
						function initSub() {
							...
							var subp1 = subjsx.create('point', [3, -2], {fillColor: 'white', strokeColor: 'black', name: 'f1'});
							var subv1 = subjsx.create('arrow', [subp, subp1], {strokecolor: 'black', strokeWidth: 3});
							var subp2 = subjsx.create('point', [1, 4], {fillColor: 'white', strokeColor: 'black', name: 'f2'});
				...
				<div style='clear: both;'>
					...
					<h2 id='cynnyrchdot'>Cynnyrch Dot</h2>
					...
					<p>Llusgwch bennau’r ddau fector i newid eu cyfeiriad a’u maint. Mae’r llinell las yn dangos cydran $\vec{b}$ i gyfeiriad $\vec{a}$, sef $\frac{\vec{a}.\vec{b}}{|\vec{a}|}$, neu gyfwerth â $|\vec{b}| cos\Theta$</p>

					<br /><br />

					<center><div id='dotgraph' class='jxgbox medgraph'></div></center>
					<div class='graphcontrols'><button onclick="JXG.JSXGraph.freeBoard(dotjsx); initDot();">Ailosod safleoedd</button> <span class='mousepos' id='dotmousepos'></span></div>
				...
				<div>
					<h2 id='hafaliadllinell'>Hafaliad Linell</h2>
					...
					<p>Llusgwch y ddau bwynt du a gwyn i addasu’r fectorau $a$ a $d$ sy’n disgrifio’r llinell goch, defnyddiwch y llithrydd i newid y gwerth sgalar ($t$).</p>

					<br /><br />

					<center><div id='linegraph' class='jxgbox medgraph'></div></center>
					<div class='graphcontrols'><button onclick="JXG.JSXGraph.freeBoard(linejsx); initLine();">Ailosod safleoedd</button> <span class='mousepos' id='linemousepos'></span></div>
